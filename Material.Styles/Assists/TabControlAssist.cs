...
/// <summary>
///     Contains attached properties for <c>TabControl</c>.
/// </summary>
public static class TabControlAssist
{
    /// <summary>
    ///     The alignment of the horizontal tab headers in the <c>TabControl</c>.
    /// </summary>
    ...
    /// <summary>
    ///     The alignment of the vertical tab headers in the <c>TabControl</c>.
    /// </summary>
    ...
    public static readonly AvaloniaProperty<double> TabHeaderInactiveOpacityProperty
        = AvaloniaProperty.RegisterAttached<TabControl, double>("TabHeaderInactiveOpacity", typeof(TabControlAssist), 1, true);
    ...
    /// <summary>
    ///     Gets the alignment of the horizontal tab headers in the <c>TabControl</c>.
    /// </summary>
    ...
    /// <summary>
    ///     Sets the alignment of the horizontal tab headers in the <c>TabControl</c>.
    /// </summary>
    /// <param name="element"></param>
    ...
    /// <summary>
    ///     Gets the alignment of the vertical tab headers in the <c>TabControl</c>.
    /// </summary>
    /// <param name="element"></param>
    ...
    /// <summary>
    ///     Sets the alignment of the vertical tab headers in the <c>TabControl</c>.
    /// </summary>
    /// <param name="element"></param>
    /// <param name="value"></param>
