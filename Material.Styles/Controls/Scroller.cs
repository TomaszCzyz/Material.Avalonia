...
public class Scroller : ContentControl, IScrollable, IScrollAnchorProvider
{
    ...
    /// </summary>
    protected double HorizontalScrollBarMaximum => Max(_extent.Width - _viewport.Width, 0);
    ...
    protected double HorizontalScrollBarValue
    {
        ...
        set
        {
            if (!(Math.Abs(_offset.X - value) > 0.001)) return; // todo: set "tolerance" somewhere else to avoid "magic number"
    ...
    /// </summary>
    protected double HorizontalScrollBarViewportSize => _viewport.Width;

    /// <summary>
    /// Gets the maximum vertical scrollbar value.
    /// </summary>
    protected double VerticalScrollBarMaximum => Max(_extent.Height - _viewport.Height, 0);
    ...
    /// </summary>
    protected double VerticalScrollBarViewportSize => _viewport.Height;
