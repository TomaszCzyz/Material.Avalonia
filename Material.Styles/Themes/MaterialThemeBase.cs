...
namespace Material.Styles.Themes
{
    public class MaterialThemeBase : AvaloniaObject, IStyle, IResourceProvider
    {
        ...
        private static IReadOnlyDictionary<string, Func<ITheme, Color>> UpdatableColors =>
            new Dictionary<string, Func<ITheme, Color>>()
            {
                ...
                },
                {
                    ...
                    theme => theme.SecondaryMid.ForegroundColor ?? theme.SecondaryMid.Color.ContrastingForegroundColor()
                },
                {
        ...
        private static Task UpdateSolidColorBrush(ITheme? oldTheme, ITheme newTheme, IResourceDictionary resourceDictionary,
            Func<Action, DispatcherPriority, Task> contextSync)
        {
            ...
            Task UpdateColorAsync(KeyValuePair<string, Func<ITheme, Color>> pair)
            {
                ...
                Task UpdateBrushAsync()
                    => contextSync(() => { brush.Color = newColor; }, DispatcherPriority.Normal);
